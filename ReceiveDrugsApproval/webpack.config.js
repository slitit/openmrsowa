 ...
 */
// generated on 2022-06-07 using @openmrs/generator-openmrs-owa 0.7.1
'use strict';
...
const THIS_APP_ID = 'receivedrugsapproval';
...
var getConfig = function () {
	  ...
	  try {
	    ...
	    config = {
	      ...
	      'APP_ENTRY_POINT': 'http://localhost:8080/openmrs/owa/receivedrugsapproval/index.html'
	    };
...
var webpackConfig = {
  quiet: false,
  entry: {
	  app : `${__dirname}/app/js/receivedrugsapproval`,
	  css: `${__dirname}/app/css/receivedrugsapproval.css`,
	  vendor : [
	        	 'jquery' 
