...
# ReceiveDrugsApproval

This repository contains the ReceiveDrugsApproval OpenMRS Open Web App.
...
This will create a file called `receivedrugsapproval.zip` file in the `dist` directory,
