...
This repository contains the wardTransfer OpenMRS Open Web App.
...
This will create a file called `wardtransfer.zip` file in the `dist` directory,
...
This will build and deploy the app to the `C:/Users/Anjana/openmrs/newserver/owatransfer/index.html`
...
```js
{
  "LOCAL_OWA_FOLDER": "C:/Users/Anjana/openmrs/newserver/owatransfer/index.html"
}
```
...
{
  "LOCAL_OWA_FOLDER": "C:/Users/Anjana/openmrs/newserver/owatransfer/index.html",
  "APP_ENTRY_POINT": "(http://localhost:8080/openmrs/owa/ward"
}
```
