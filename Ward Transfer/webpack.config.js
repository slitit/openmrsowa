...
const THIS_APP_ID = 'wardtransfer';
	  ...
	  try {
	    ...
	    config = {
		 'LOCAL_OWA_FOLDER': 'C:/Users/Anjana/openmrs/newserver/owa/',
	      'APP_ENTRY_POINT': 'http://localhost:8080/openmrs/owa/owatransfer/index.html'
	    };
...
var webpackConfig = {
  quiet: false,
  entry: {
	  app : `${__dirname}/app/js/wardtransfer`,
	  css: `${__dirname}/app/css/wardtransfer.css`,
	  vendor : [
	        	 'jquery' 
