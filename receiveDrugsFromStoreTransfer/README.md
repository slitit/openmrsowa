...
# Receive Drugs From Store Transfer

This repository contains the Receive Drugs From Store Transfer OpenMRS Open Web App.
...
This will create a file called `receivedrugsfromstoretransfer.zip` file in the `dist` directory,
...
This will build and deploy the app to the `C:/Users/Dilki/openmrs/newserver/owa`
...
```js
{
  "LOCAL_OWA_FOLDER": "C:/Users/Dilki/openmrs/newserver/owa"
}
```
...
{
  "LOCAL_OWA_FOLDER": "C:/Users/Dilki/openmrs/newserver/owa",
  "APP_ENTRY_POINT": "http://localhost:8080/openmrs/owa/receivedrugsfromstoretransfer/index.html"
}
```
