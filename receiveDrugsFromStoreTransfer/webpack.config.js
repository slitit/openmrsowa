 ...
 */
// generated on 2021-08-31 using @openmrs/generator-openmrs-owa 0.7.1
'use strict';
...
const THIS_APP_ID = 'receivedrugsfromstoretransfer';
...
var webpackConfig = {
  quiet: false,
  entry: {
	  app : `${__dirname}/app/js/receivedrugsfromstoretransfer`,
	  css: `${__dirname}/app/css/receivedrugsfromstoretransfer.css`,
	  vendor : [
	        	 'jquery' 
