 ...
 */
// generated on 2021-09-13 using @openmrs/generator-openmrs-owa 0.7.1
'use strict';
...
var getConfig = function () {
	  ...
	  try {
	    ...
	    config = {
	      ...
	      'APP_ENTRY_POINT': 'http://localhost:8080/openmrs/owa/drugmodule/index.html'
	    };
...
var webpackConfig = {
  quiet: false,
  entry: {
	  app : `${__dirname}/app/js/drugmodule`,
	  css: `${__dirname}/app/css/drugmodule.css`,
	  vendor : [
	        	 'jquery' 
