...
This repository contains the Drugs Dosages OpenMRS Open Web App.
...
This will create a file called `drugsdosages.zip` file in the `dist` directory,
...
{
  "LOCAL_OWA_FOLDER": "C:/Users/Dilki/openmrs/newserver/owa",
  "APP_ENTRY_POINT": "http://localhost:8080/openmrs/owa/drugsdosages/index.html"
}
```
