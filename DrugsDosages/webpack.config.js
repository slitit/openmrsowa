 ...
 */
// generated on 2021-08-30 using @openmrs/generator-openmrs-owa 0.7.1
'use strict';
...
const THIS_APP_ID = 'drugsdosages';
...
var webpackConfig = {
  quiet: false,
  entry: {
	  app : `${__dirname}/app/js/drugsdosages`,
	  css: `${__dirname}/app/css/drugsdosages.css`,
	  vendor : [
	        	 'jquery' 
