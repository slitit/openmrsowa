 ...
 */
// generated on 2022-05-04 using @openmrs/generator-openmrs-owa 0.7.1
'use strict';
...
var getConfig = function () {
	  ...
	  try {
	    ...
	    config = {
	      ...
	      'APP_ENTRY_POINT': 'http://localhost:8080/openmrs/owa/section/index.html'
	    };
...
var webpackConfig = {
  quiet: false,
  entry: {
	  app : `${__dirname}/app/js/section`,
	  css: `${__dirname}/app/css/section.css`,
	  vendor : [
	        	 'jquery' 
