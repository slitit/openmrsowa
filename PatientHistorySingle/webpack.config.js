 ...
 */
// generated on 2022-08-03 using @openmrs/generator-openmrs-owa 0.7.1
'use strict';
...
const THIS_APP_ID = 'patienthistorysingle';
...
var getConfig = function () {
	  ...
	  try {
	    ...
	    config = {
	      ...
	      'APP_ENTRY_POINT': 'http://localhost:8080/openmrs/owa/patienthistorysingle/index.html'
	    };
...
var webpackConfig = {
  quiet: false,
  entry: {
	  app : `${__dirname}/app/js/patienthistorysingle`,
	  css: `${__dirname}/app/css/patienthistorysingle.css`,
	  vendor : [
	        	 'jquery' 
