...
# PatientHistorySingle

This repository contains the PatientHistorySingle OpenMRS Open Web App.
...
This will create a file called `patienthistorysingle.zip` file in the `dist` directory,
