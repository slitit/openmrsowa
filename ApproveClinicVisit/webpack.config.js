 ...
 */
// generated on 2021-11-02 using @openmrs/generator-openmrs-owa 0.7.1
'use strict';
...
const THIS_APP_ID = 'approveclinicvisitvisit';
...
var getConfig = function () {
	  ...
	  try {
	    ...
	    config = {
	      ...
	      'APP_ENTRY_POINT': 'http://localhost:8080/openmrs/owa/approveclinicvisitvisit/index.html'
	    };
...
var webpackConfig = {
  quiet: false,
  entry: {
	  app : `${__dirname}/app/js/approveclinicvisitvisit`,
	  css: `${__dirname}/app/css/approveclinicvisitvisit.css`,
	  vendor : [
	        	 'jquery' 
