...
# ApproveClinicVisitVisit

This repository contains the ApproveClinicVisitVisit OpenMRS Open Web App.
...
This will create a file called `approveclinicvisitvisit.zip` file in the `dist` directory,
