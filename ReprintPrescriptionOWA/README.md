...
This repository contains the ReprintPrescription OpenMRS Open Web App.
...
This will create a file called `reprintprescription.zip` file in the `dist` directory,
