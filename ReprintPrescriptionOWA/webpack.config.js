...
const THIS_APP_ID = 'reprintprescription';
...
var getConfig = function () {
	  ...
	  try {
	    ...
	    config = {
	      ...
	      'APP_ENTRY_POINT': 'http://localhost:8080/openmrs/owa/reprintprescription/index.html'
	    };
...
var webpackConfig = {
  quiet: false,
  entry: {
	  app : `${__dirname}/app/js/reprintprescription`,
	  css: `${__dirname}/app/css/reprintprescription.css`,
	  vendor : [
	        	 'jquery' 
