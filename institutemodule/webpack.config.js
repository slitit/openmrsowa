 ...
 */
// generated on 2021-12-31 using @openmrs/generator-openmrs-owa 0.7.1
'use strict';
...
const THIS_APP_ID = 'institutemodule';
...
var webpackConfig = {
  quiet: false,
  entry: {
	  app : `${__dirname}/app/js/institutemodule`,
	  css: `${__dirname}/app/css/institutemodule.css`,
	  vendor : [
	        	 'jquery' 
