 ...
 */
// generated on 2022-05-09 using @openmrs/generator-openmrs-owa 0.7.1
'use strict';
...
var webpackConfig = {
  quiet: false,
  entry: {
	  app : `${__dirname}/app/js/drugsmaster`,
	  css: `${__dirname}/app/css/drugsmaster.css`,
	  vendor : [
	        	 'jquery' 
