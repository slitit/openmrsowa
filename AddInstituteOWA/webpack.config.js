...
const THIS_APP_ID = 'addinstitute';
...
var getConfig = function () {
	  ...
	  try {
	    ...
	    config = {
	      ...
	      'APP_ENTRY_POINT': 'http://localhost:8080/openmrs/owa/addinstitute/index.html'
	    };
...
var webpackConfig = {
  quiet: false,
  entry: {
	  app : `${__dirname}/app/js/addinstitute.js`,
	  css: `${__dirname}/app/css/addinstitute.css`,
	  vendor : [
	        	 'jquery' 
