 ...
 */
// generated on 2021-08-13 using @openmrs/generator-openmrs-owa 0.7.1
'use strict';
...
const THIS_APP_ID = 'userregistration';
...
var getConfig = function () {
	  ...
	  try {
	    ...
	    config = {
	      ...
	      'APP_ENTRY_POINT': 'http://localhost:8080/openmrs/owa/userregistration/index.html'
	    };
...
var webpackConfig = {
  quiet: false,
  entry: {
	  app : `${__dirname}/app/js/userregistration`,
	  css: `${__dirname}/app/css/userregistration.css`,
	  vendor : [
	        	 'jquery' 
