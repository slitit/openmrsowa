...
const THIS_APP_ID = 'labmanagement';
...
var getConfig = function () {
	  ...
	  try {
	    ...
	    config = {
	      ...
	      'APP_ENTRY_POINT': 'http://localhost:8080/openmrs/owa/labmanagement/index.html'
	    };
...
var webpackConfig = {
  quiet: false,
  entry: {
	  app : `${__dirname}/app/js/labmanagement`,
	  css: `${__dirname}/app/css/labmanagement.css`,
	  vendor : [
	        	 'jquery' 
