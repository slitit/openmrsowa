 ...
 */
// generated on 2021-11-03 using @openmrs/generator-openmrs-owa 0.7.1
'use strict';
...
const THIS_APP_ID = 'examinationinward';
...
var getConfig = function () {
	  ...
	  try {
	    ...
	    config = {
	      ...
	      'APP_ENTRY_POINT': 'http://localhost:8080/openmrs/owa/examinationinward/index.html'
	    };
...
var webpackConfig = {
  quiet: false,
  entry: {
	  app : `${__dirname}/app/js/examinationinward`,
	  css: `${__dirname}/app/css/examinationinward.css`,
	  vendor : [
	        	 'jquery' 
