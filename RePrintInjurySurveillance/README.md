...
# RePrintInjurySurveillance

This repository contains the RePrintInjurySurveillance OpenMRS Open Web App.
...
This will create a file called `reprintinjurysurveillance.zip` file in the `dist` directory,
