 ...
 */
// generated on 2022-06-27 using @openmrs/generator-openmrs-owa 0.7.1
'use strict';
...
const THIS_APP_ID = 'reprintinjurysurveillance';
...
var getConfig = function () {
	  ...
	  try {
	    ...
	    config = {
	      ...
	      'APP_ENTRY_POINT': 'http://localhost:8080/openmrs/owa/reprintinjurysurveillance/index.html'
	    };
...
var webpackConfig = {
  quiet: false,
  entry: {
	  app : `${__dirname}/app/js/reprintinjurysurveillance`,
	  css: `${__dirname}/app/css/reprintinjurysurveillance.css`,
	  vendor : [
	        	 'jquery' 
