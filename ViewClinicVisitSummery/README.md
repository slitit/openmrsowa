...
# ViewClinicVisitSummery

This repository contains the ViewClinicVisitSummery OpenMRS Open Web App.
...
This will create a file called `viewclinicvisitsummery.zip` file in the `dist` directory,
