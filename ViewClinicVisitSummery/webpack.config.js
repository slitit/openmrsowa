 ...
 */
// generated on 2021-11-05 using @openmrs/generator-openmrs-owa 0.7.1
'use strict';
...
const THIS_APP_ID = 'viewclinicvisitsummery';
...
var getConfig = function () {
	  ...
	  try {
	    ...
	    config = {
	      ...
	      'APP_ENTRY_POINT': 'http://localhost:8080/openmrs/owa/viewclinicvisitsummery/index.html'
	    };
...
var webpackConfig = {
  quiet: false,
  entry: {
	  app : `${__dirname}/app/js/viewclinicvisitsummery.js`,
	  css: `${__dirname}/app/css/viewclinicvisitsummery.css`,
	  vendor : [
	        	 'jquery' 
