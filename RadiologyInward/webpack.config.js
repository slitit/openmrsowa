 ...
 */
// generated on 2021-11-16 using @openmrs/generator-openmrs-owa 0.7.1
'use strict';
...
const THIS_APP_ID = 'radiologyinward';
...
var getConfig = function () {
	  ...
	  try {
	    ...
	    config = {
	      ...
	      'APP_ENTRY_POINT': 'http://localhost:8080/openmrs/owa/radiologyinward/index.html'
	    };
...
var webpackConfig = {
  quiet: false,
  entry: {
	  app : `${__dirname}/app/js/radiologyinward`,
	  css: `${__dirname}/app/css/radiologyinward.css`,
	  vendor : [
	        	 'jquery' 
