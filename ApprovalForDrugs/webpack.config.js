 ...
 */
// generated on 2022-06-08 using @openmrs/generator-openmrs-owa 0.7.1
'use strict';
...
const THIS_APP_ID = 'approvalfordrugs';
...
var getConfig = function () {
	  ...
	  try {
	    ...
	    config = {
	      ...
	      'APP_ENTRY_POINT': 'http://localhost:8080/openmrs/owa/approvalfordrugs/index.html'
	    };
...
var webpackConfig = {
  quiet: false,
  entry: {
	  app : `${__dirname}/app/js/approvalfordrugs`,
	  css: `${__dirname}/app/css/approvalfordrugs.css`,
	  vendor : [
	        	 'jquery' 
