...
This repository contains the ListOfNotifiableDiseases OpenMRS Open Web App.
...
This will create a file called `listofnotifiablediseases.zip` file in the `dist` directory,
