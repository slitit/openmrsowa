 ...
 */
// generated on 2022-06-21 using @openmrs/generator-openmrs-owa 0.7.1
'use strict';
...
const THIS_APP_ID = 'listofnotifiablediseases';
...
var getConfig = function () {
	  ...
	  try {
	    ...
	    config = {
	      ...
	      'APP_ENTRY_POINT': 'http://localhost:8080/openmrs/owa/listofnotifiablediseases/index.html'
	    };
...
var webpackConfig = {
  quiet: false,
  entry: {
	  app : `${__dirname}/app/js/listofnotifiablediseases`,
	  css: `${__dirname}/app/css/listofnotifiablediseases.css`,
	  vendor : [
	        	 'jquery' 
