 ...
 */
// generated on 2021-08-09 using @openmrs/generator-openmrs-owa 0.7.1
'use strict';
...
const THIS_APP_ID = 'patientsearch';
...
var getConfig = function () {
	  ...
	  try {
	    ...
	    config = {
	      ...
	      'APP_ENTRY_POINT': 'http://localhost:8080/openmrs/owa/patientsearch/index.html'
	    };
...
var webpackConfig = {
  quiet: false,
  entry: {
	  app : `${__dirname}/app/js/patientsearch`,
	  css: `${__dirname}/app/css/patientsearch.css`,
	  vendor : [
	        	 'jquery' 
