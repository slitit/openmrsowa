 ...
 */
// generated on 2021-09-06 using @openmrs/generator-openmrs-owa 0.7.1
'use strict';
...
const THIS_APP_ID = 'returndrugstosupplier';
...
var webpackConfig = {
  quiet: false,
  entry: {
	  app : `${__dirname}/app/js/returndrugstosupplier`,
	  css: `${__dirname}/app/css/returndrugstosupplier.css`,
	  vendor : [
	        	 'jquery' 
