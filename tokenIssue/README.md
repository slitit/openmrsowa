...
This repository contains the tokenIssue OpenMRS Open Web App.
...
This will create a file called `tokenissue.zip` file in the `dist` directory,
...
{
  "LOCAL_OWA_FOLDER": "C:/Users/DELL/openmrs/newserver/owa",
  "APP_ENTRY_POINT": "http://localhost:8080/openmrs/owa/tokenissue/index.html"
}
```
