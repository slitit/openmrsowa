 ...
 */
// generated on 2021-10-07 using @openmrs/generator-openmrs-owa 0.7.1
'use strict';
...
const THIS_APP_ID = 'externalwardtransfer';
...
var getConfig = function () {
	  ...
	  try {
	    ...
	    config = {
	      ...
	      'APP_ENTRY_POINT': 'http://localhost:8080/openmrs/owa/externalWardTransfer/index.html'
	    };
...
var webpackConfig = {
  quiet: false,
  entry: {
	  app : `${__dirname}/app/js/externalwardtransfer`,
	  css: `${__dirname}/app/css/externalwardtransfer.css`,
	  vendor : [
	        	 'jquery' 
