...
# External Ward Transfer

This repository contains the External Ward Transfer OpenMRS Open Web App.
...
This will create a file called `externalwardtransfer.zip` file in the `dist` directory,
...
This will build and deploy the app to the `C:/Users/Anjana/openmrs/newserver/owa/rnalwardtransfer/index.html`
...
```js
{
  "LOCAL_OWA_FOLDER": "C:/Users/Anjana/openmrs/newserver/owa/rnalwardtransfer/index.html"
}
```
...
{
  "LOCAL_OWA_FOLDER": "C:/Users/Anjana/openmrs/newserver/owa/rnalwardtransfer/index.html",
  "APP_ENTRY_POINT": "http://localhost:8080/openmrs/owa/exte"
}
```
