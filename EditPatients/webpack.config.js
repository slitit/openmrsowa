 ...
 */
// generated on 2022-07-21 using @openmrs/generator-openmrs-owa 0.7.1
'use strict';
...
const THIS_APP_ID = 'editpatients';
...
var getConfig = function () {
	  ...
	  try {
	    ...
	    config = {
	      ...
	      'APP_ENTRY_POINT': 'http://localhost:8080/openmrs/owa/editpatients/index.html'
	    };
...
var webpackConfig = {
  quiet: false,
  entry: {
	  app : `${__dirname}/app/js/editpatients`,
	  css: `${__dirname}/app/css/editpatients.css`,
	  vendor : [
	        	 'jquery' 
