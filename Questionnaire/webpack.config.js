 ...
 */
// generated on 2021-09-20 using @openmrs/generator-openmrs-owa 0.7.1
'use strict';
...
const THIS_APP_ID = 'questionnaire';
...
var webpackConfig = {
  quiet: false,
  entry: {
	  app : `${__dirname}/app/js/questionnaire`,
	  css: `${__dirname}/app/css/questionnaire.css`,
	  vendor : [
	        	 'jquery' 
