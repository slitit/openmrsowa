...
const THIS_APP_ID = 'wardpatientmanagement';
...
var getConfig = function () {
	  ...
	  try {
	    ...
	    config = {
	      ...
	      'APP_ENTRY_POINT': 'http://localhost:8080/openmrs/owa/wardpatientmanagement/index.html'
	    };
...
var webpackConfig = {
  quiet: false,
  entry: {
	  app : `${__dirname}/app/js/wardpatientmanagement`,
	  css: `${__dirname}/app/css/wardpatientmanagement.css`,
	  vendor : [
	        	 'jquery' 
