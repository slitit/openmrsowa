...
# WardPatientManagement

This repository contains the WardPatientManagement OpenMRS Open Web App.
...
This will create a file called `wardpatientmanagement.zip` file in the `dist` directory,
