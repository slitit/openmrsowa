...
# WardPatientManagementSelect

This repository contains the WardPatientManagementSelect OpenMRS Open Web App.
...
This will create a file called `wardpatientmanagementselect.zip` file in the `dist` directory,
