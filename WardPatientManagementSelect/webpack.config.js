 ...
 */
// generated on 2021-11-09 using @openmrs/generator-openmrs-owa 0.7.1
'use strict';
...
const THIS_APP_ID = 'wardpatientmanagementselect';
...
var getConfig = function () {
	  ...
	  try {
	    ...
	    config = {
	      'LOCAL_OWA_FOLDER': 'C:/Users/Himasha/openmrs/newserver/owa/',
	      'APP_ENTRY_POINT': 'http://localhost:8080/openmrs/owa/wardpatientmanagementselect/index.html'
	    };
...
var webpackConfig = {
  quiet: false,
  entry: {
	  app : `${__dirname}/app/js/wardpatientmanagementselect.js`,
	  css: `${__dirname}/app/css/wardpatientmanagementselect.css`,
	  vendor : [
	        	 'jquery' 
