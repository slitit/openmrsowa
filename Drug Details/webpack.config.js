 ...
 */
// generated on 2021-08-26 using @openmrs/generator-openmrs-owa 0.7.1
'use strict';
...
var webpackConfig = {
  quiet: false,
  entry: {
	  app : `${__dirname}/app/js/drugdetails`,
	  css: `${__dirname}/app/css/drugdetails.css`,
	  vendor : [
	        	 'jquery' 
