...
This repository contains the Drug Details OpenMRS Open Web App.
...
This will create a file called `drugdetails.zip` file in the `dist` directory,
...
This will build and deploy the app to the `C:/Users/dinuk/openmrs/newserver/owa`
...
```js
{
  "LOCAL_OWA_FOLDER": "C:/Users/dinuk/openmrs/newserver/owa"
}
```
...
{
  "LOCAL_OWA_FOLDER": "C:/Users/dinuk/openmrs/newserver/owa",
  "APP_ENTRY_POINT": "http://localhost:8080/openmrs/owa/drugdetails/index.html"
}
```
