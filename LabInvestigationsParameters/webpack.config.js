 ...
 */
// generated on 2021-08-25 using @openmrs/generator-openmrs-owa 0.7.1
'use strict';
...
const THIS_APP_ID = 'labinvestigationsparameters';
...
var webpackConfig = {
  quiet: false,
  entry: {
	  app : `${__dirname}/app/js/labinvestigationsparameters`,
	  css: `${__dirname}/app/css/labinvestigationsparameters.css`,
	  vendor : [
	        	 'jquery' 
