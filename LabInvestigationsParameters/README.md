...
# LabInvestigationsParameters

This repository contains the LabInvestigationsParameters OpenMRS Open Web App.
...
This will create a file called `labinvestigationsparameters.zip` file in the `dist` directory,
...
This will build and deploy the app to the `C:/Users/Anjana/openmrs/newserver/owa`
...
```js
{
  "LOCAL_OWA_FOLDER": "C:/Users/Anjana/openmrs/newserver/owa"
}
```
...
{
  "LOCAL_OWA_FOLDER": "C:/Users/Anjana/openmrs/newserver/owa",
  "APP_ENTRY_POINT": "http://localhost:8080/openmrs/owa/labinvestigationsparameters/index.html"
}
```
