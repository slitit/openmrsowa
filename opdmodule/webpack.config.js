 ...
 */
// generated on 2022-01-03 using @openmrs/generator-openmrs-owa 0.7.1
'use strict';
...
var webpackConfig = {
  quiet: false,
  entry: {
	  app : `${__dirname}/app/js/opdmodule`,
	  css: `${__dirname}/app/css/opdmodule.css`,
	  vendor : [
	        	 'jquery' 
