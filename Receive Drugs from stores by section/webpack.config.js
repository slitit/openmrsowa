 ...
 */
// generated on 2021-10-22 using @openmrs/generator-openmrs-owa 0.7.1
'use strict';
...
var getConfig = function () {
	  ...
	  try {
	    ...
	    config = {
	      ...
	      'APP_ENTRY_POINT': 'http://localhost:8080/openmrs/owa/drugs/index.html'
	    };
...
var webpackConfig = {
  quiet: false,
  entry: {
	  app : `${__dirname}/app/js/drugs.js`,
	  css: `${__dirname}/app/css/drugs.css`,
	  vendor : [
	        	 'jquery' 
