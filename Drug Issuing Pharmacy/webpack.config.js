 ...
 */
// generated on 2021-08-27 using @openmrs/generator-openmrs-owa 0.7.1
'use strict';
...
const THIS_APP_ID = 'drugissuingpharmcy';
...
var getConfig = function () {
	  ...
	  try {
	    ...
	    config = {
	      ...
	      'APP_ENTRY_POINT': 'http://localhost:8080/openmrs/owa/drugissuingpharmcy/index.html'
	    };
...
var webpackConfig = {
  quiet: false,
  entry: {
	  app : `${__dirname}/app/js/drugissuingpharmcy`,
	  css: `${__dirname}/app/css/drugissuingpharmcy.css`,
	  vendor : [
	        	 'jquery' 
