 ...
 */
// generated on 2022-01-26 using @openmrs/generator-openmrs-owa 0.7.1
'use strict';
...
const THIS_APP_ID = 'clinicvistsummery';
...
var webpackConfig = {
  quiet: false,
  entry: {
	  app : `${__dirname}/app/js/clinicvistsummery`,
	  css: `${__dirname}/app/css/clinicvistsummery.css`,
	  vendor : [
	        	 'jquery' 
