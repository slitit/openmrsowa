...
This repository contains the ClinicVistSummery OpenMRS Open Web App.
...
This will create a file called `clinicvistsummery.zip` file in the `dist` directory,
...
This will build and deploy the app to the `C:/Users/DELL/openmrs/newserver/owa`
...
```js
{
  "LOCAL_OWA_FOLDER": "C:/Users/DELL/openmrs/newserver/owa"
}
```
...
{
  "LOCAL_OWA_FOLDER": "C:/Users/DELL/openmrs/newserver/owa",
  "APP_ENTRY_POINT": "http://localhost:8080/openmrs/owa/clinicvistsummery/index.html"
}
```
