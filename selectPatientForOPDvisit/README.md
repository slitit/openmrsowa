...
# selectPatientForOPDvisit

This repository contains the selectPatientForOPDvisit OpenMRS Open Web App.
...
This will create a file called `selectpatientforopdvisit.zip` file in the `dist` directory,
