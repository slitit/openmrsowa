...
const THIS_APP_ID = 'selectpatientforopdvisit';
...
var getConfig = function () {
	  ...
	  try {
	    ...
	    config = {
	      ...
	      'APP_ENTRY_POINT': 'http://localhost:8080/openmrs/owa/selectpatientforopdvisit/index.html'
	    };
...
var webpackConfig = {
  quiet: false,
  entry: {
	  app : `${__dirname}/app/js/selectpatientforopdvisit`,
	  css: `${__dirname}/app/css/selectpatientforopdvisit.css`,
	  vendor : [
	        	 'jquery' 
