...
This repository contains the QMSApp OpenMRS Open Web App.
...
This will create a file called `qmsapp.zip` file in the `dist` directory,
...
{
  "LOCAL_OWA_FOLDER": "C:/Users/Anjana/openmrs/newserver/owa",
  "APP_ENTRY_POINT": "http://localhost:8080/openmrs/owa/qmsapp/index.html"
}
```
