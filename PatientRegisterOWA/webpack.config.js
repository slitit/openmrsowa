 ...
 */
// generated on 2021-08-12 using @openmrs/generator-openmrs-owa 0.7.1
'use strict';
...
const THIS_APP_ID = 'patientregister';
...
var getConfig = function () {
	  ...
	  try {
	    ...
	    config = {
	      ...
	      'APP_ENTRY_POINT': 'http://localhost:8080/openmrs/owa/patientregister/index.html'
	    };
...
var webpackConfig = {
  quiet: false,
  entry: {
	  app : `${__dirname}/app/js/patientregister.js`,
	  css: `${__dirname}/app/css/patientregister.css`,
	  vendor : [
	        	 'jquery' 
