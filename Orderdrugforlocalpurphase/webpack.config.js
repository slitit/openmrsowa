 ...
 */
// generated on 2021-08-20 using @openmrs/generator-openmrs-owa 0.7.1
'use strict';
...
const THIS_APP_ID = 'orderdrugforlocalpurphase';
...
var webpackConfig = {
  quiet: false,
  entry: {
	  app : `${__dirname}/app/js/orderdrugforlocalpurphase`,
	  css: `${__dirname}/app/css/orderdrugforlocalpurphase.css`,
	  vendor : [
	        	 'jquery' 
