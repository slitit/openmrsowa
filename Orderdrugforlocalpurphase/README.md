...
# Order drug for local purphase

This repository contains the Order drug for local purphase OpenMRS Open Web App.
...
This will create a file called `orderdrugforlocalpurphase.zip` file in the `dist` directory,
...
{
  "LOCAL_OWA_FOLDER": "C:/Users/Dilki/openmrs/newserver/owa",
  "APP_ENTRY_POINT": "http://localhost:8080/openmrs/owa/orderdrugforlocalpurphase/index.html"
}
```
