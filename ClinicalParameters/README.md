...
This repository contains the ClinicParameters OpenMRS Open Web App.
...
This will create a file called `clinicparameters.zip` file in the `dist` directory,
...
{
  "LOCAL_OWA_FOLDER": "C:/Users/Anjana/openmrs/newserver/owa",
  "APP_ENTRY_POINT": "CinicParameters"
}
```
