 ...
 */
// generated on 2021-09-17 using @openmrs/generator-openmrs-owa 0.7.1
'use strict';
...
const THIS_APP_ID = 'clinicparameters';
...
var webpackConfig = {
  quiet: false,
  entry: {
	  app : `${__dirname}/app/js/clinicparameters`,
	  css: `${__dirname}/app/css/clinicparameters.css`,
	  vendor : [
	        	 'jquery' 
