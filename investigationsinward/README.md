...
# investigationsinward

This repository contains the investigationsinward OpenMRS Open Web App.
...
This will create a file called `investigationsinward.zip` file in the `dist` directory,
...
This will build and deploy the app to the `C:/Users/kapil/openmrs/openmrs-platform/owa`
...
```js
{
  "LOCAL_OWA_FOLDER": "C:/Users/kapil/openmrs/openmrs-platform/owa"
}
```
...
{
  "LOCAL_OWA_FOLDER": "C:/Users/kapil/openmrs/openmrs-platform/owa",
  "APP_ENTRY_POINT": "http://localhost:8080/openmrs/owa/investigationsinward/index.html"
}
```
