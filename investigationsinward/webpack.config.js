 ...
 */
// generated on 2021-11-04 using @openmrs/generator-openmrs-owa 0.7.1
'use strict';
...
const THIS_APP_ID = 'investigationsinward';
...
var webpackConfig = {
  quiet: false,
  entry: {
	  app : `${__dirname}/app/js/investigationsinward.js`,
	  css: `${__dirname}/app/css/investigationsinward.css`,
	  vendor : [
	        	 'jquery' 
