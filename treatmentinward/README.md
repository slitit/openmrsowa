...
This repository contains the treatmentinward OpenMRS Open Web App.
...
This will create a file called `treatmentinward.zip` file in the `dist` directory,
...
{
  "LOCAL_OWA_FOLDER": "C:/Users/kapil/openmrs/openmrs-platform/owa",
  "APP_ENTRY_POINT": "http://localhost:8080/openmrs/owa/treatmentinward/index.html"
}
```
