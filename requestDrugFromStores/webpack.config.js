 ...
 */
// generated on 2021-12-13 using @openmrs/generator-openmrs-owa 0.7.1
'use strict';
...
const THIS_APP_ID = 'requestdrugfromstores';
...
var webpackConfig = {
  quiet: false,
  entry: {
	  app : `${__dirname}/app/js/requestdrugfromstores`,
	  css: `${__dirname}/app/css/requestdrugfromstores.css`,
	  vendor : [
	        	 'jquery' 
