...
const THIS_APP_ID = 'prescriptioninward';
...
var getConfig = function () {
	  ...
	  try {
	    ...
	    config = {
	      ...
	      'APP_ENTRY_POINT': 'http://localhost:8080/openmrs/owa/prescriptioninward/index.html'
	    };
...
var webpackConfig = {
  quiet: false,
  entry: {
	  app : `${__dirname}/app/js/prescriptioninward.js`,
	  css: `${__dirname}/app/css/prescriptioninward.css`,
	  vendor : [
	        	 'jquery' 
