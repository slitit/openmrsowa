...
# ReceiveSampleFromLab

This repository contains the ReceiveSampleFromLab OpenMRS Open Web App.
...
This will create a file called `receivesamplefromlab.zip` file in the `dist` directory,
