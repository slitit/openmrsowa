 ...
 */
// generated on 2022-07-04 using @openmrs/generator-openmrs-owa 0.7.1
'use strict';
...
const THIS_APP_ID = 'receivesamplefromlab';
...
var getConfig = function () {
	  ...
	  try {
	    ...
	    config = {
	      ...
	      'APP_ENTRY_POINT': 'http://localhost:8080/openmrs/owa/receivesamplefromlab/index.html'
	    };
...
var webpackConfig = {
  quiet: false,
  entry: {
	  app : `${__dirname}/app/js/receivesamplefromlab`,
	  css: `${__dirname}/app/css/receivesamplefromlab.css`,
	  vendor : [
	        	 'jquery' 
