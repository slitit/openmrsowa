 ...
 */
// generated on 2022-06-20 using @openmrs/generator-openmrs-owa 0.7.1
'use strict';
...
const THIS_APP_ID = 'samplecollection';
...
var getConfig = function () {
	  ...
	  try {
	    ...
	    config = {
	      ...
	      'APP_ENTRY_POINT': 'http://localhost:8080/openmrs/owa/samplecollection/index.html'
	    };
...
var webpackConfig = {
  quiet: false,
  entry: {
	  app : `${__dirname}/app/js/samplecollection`,
	  css: `${__dirname}/app/css/samplecollection.css`,
	  vendor : [
	        	 'jquery' 
