 ...
 */
// generated on 2021-12-08 using @openmrs/generator-openmrs-owa 0.7.1
'use strict';
...
const THIS_APP_ID = 'procedureorderlist';
...
var webpackConfig = {
  quiet: false,
  entry: {
	  app : `${__dirname}/app/js/procedureorderlist.js`,
	  css: `${__dirname}/app/css/procedureorderlist.css`,
	  vendor : [
	        	 'jquery' 
