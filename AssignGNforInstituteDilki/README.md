...
# Assign GN for Institute

This repository contains the Assign GN for Institute OpenMRS Open Web App.
...
This will create a file called `assigngnforinstitute.zip` file in the `dist` directory,
...
{
  "LOCAL_OWA_FOLDER": "C:/Users/Dilki/openmrs/newserver/owa",
  "APP_ENTRY_POINT": "http://localhost:8080/openmrs/owa/assigngnforinstitute/index.html"
}
```
