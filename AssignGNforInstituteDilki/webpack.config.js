 ...
 */
// generated on 2021-08-16 using @openmrs/generator-openmrs-owa 0.7.1
'use strict';
...
const THIS_APP_ID = 'assigngnforinstitute';
...
var webpackConfig = {
  quiet: false,
  entry: {
	  app : `${__dirname}/app/js/assigngnforinstitute`,
	  css: `${__dirname}/app/css/assigngnforinstitute.css`,
	  vendor : [
	        	 'jquery' 
