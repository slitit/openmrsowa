...
# selectPatientForClinicVisit

This repository contains the selectPatientForClinicVisit OpenMRS Open Web App.
...
This will create a file called `selectpatientforclinicvisit.zip` file in the `dist` directory,
