 ...
 */
// generated on 2021-12-23 using @openmrs/generator-openmrs-owa 0.7.1
'use strict';
...
const THIS_APP_ID = 'selectpatientforclinicvisit';
...
var getConfig = function () {
	  ...
	  try {
	    ...
	    config = {
	      ...
	      'APP_ENTRY_POINT': 'http://localhost:8080/openmrs/owa/selectpatientforclinicvisit/index.html'
	    };
...
var webpackConfig = {
  quiet: false,
  entry: {
	  app : `${__dirname}/app/js/selectpatientforclinicvisit`,
	  css: `${__dirname}/app/css/selectpatientforclinicvisit.css`,
	  vendor : [
	        	 'jquery' 
