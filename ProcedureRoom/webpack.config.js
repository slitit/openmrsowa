...
const THIS_APP_ID = 'procedureroom';
...
var getConfig = function () {
	  ...
	  try {
	    ...
	    config = {
	      ...
	      'APP_ENTRY_POINT': 'http://localhost:8080/openmrs/owa/procedureroom/index.html'
	    };
...
var webpackConfig = {
  quiet: false,
  entry: {
	  app : `${__dirname}/app/js/procedureroom.js`,
	  css: `${__dirname}/app/css/procedureroom.css`,
	  vendor : [
	        	 'jquery' 
