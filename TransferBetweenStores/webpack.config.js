 ...
 */
// generated on 2021-12-07 using @openmrs/generator-openmrs-owa 0.7.1
'use strict';
...
const THIS_APP_ID = 'transferbetweenstores';
...
var getConfig = function () {
	  ...
	  try {
	    ...
	    config = {
	      'LOCAL_OWA_FOLDER': 'C:/Users/kapil/openmrs/newserver/owa/',
...
var webpackConfig = {
  quiet: false,
  entry: {
	  app : `${__dirname}/app/js/transferbetweenstores.js`,
	  css: `${__dirname}/app/css/transferbetweenstores.css`,
	  vendor : [
	        	 'jquery' 
