...
This repository contains the radiologyorderlist OpenMRS Open Web App.
...
This will create a file called `radiologyorderlist.zip` file in the `dist` directory,
...
{
  "LOCAL_OWA_FOLDER": "C:/Users/kapil/openmrs/openmrs-platform/owa",
  "APP_ENTRY_POINT": "http://localhost:8080/openmrs/owa/radiologyorderlist/index.html"
}
```
