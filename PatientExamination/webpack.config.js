 ...
 */
// generated on 2022-05-18 using @openmrs/generator-openmrs-owa 0.7.1
'use strict';
...
const THIS_APP_ID = 'patientexamination';
...
var getConfig = function () {
	  ...
	  try {
	    ...
	    config = {
	      ...
	      'APP_ENTRY_POINT': 'http://localhost:8080/openmrs/owa/patientexamination/index.html'
	    };
...
var webpackConfig = {
  quiet: false,
  entry: {
	  app : `${__dirname}/app/js/patientexamination`,
	  css: `${__dirname}/app/css/patientexamination.css`,
	  vendor : [
	        	 'jquery' 
