 ...
 */
// generated on 2021-11-01 using @openmrs/generator-openmrs-owa 0.7.1
'use strict';
...
const THIS_APP_ID = 'allergyinward';
...
var getConfig = function () {
	  ...
	  try {
	    ...
	    config = {
	      ...
	      'APP_ENTRY_POINT': 'http://localhost:8080/openmrs/owa/allergyinward/index.html'
	    };
...
var webpackConfig = {
  quiet: false,
  entry: {
	  app : `${__dirname}/app/js/allergyinward.js`,
	  css: `${__dirname}/app/css/allergyinward.css`,
	  vendor : [
	        	 'jquery' 
