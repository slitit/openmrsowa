 ...
 */
// generated on 2022-07-26 using @openmrs/generator-openmrs-owa 0.7.1
'use strict';
...
const THIS_APP_ID = 'storemanagement';
...
var getConfig = function () {
	  ...
	  try {
	    ...
	    config = {
	      ...
	      'APP_ENTRY_POINT': 'http://localhost:8080/openmrs/owa/storemanagement/index.html'
	    };
...
var webpackConfig = {
  quiet: false,
  entry: {
	  app : `${__dirname}/app/js/storemanagement`,
	  css: `${__dirname}/app/css/storemanagement.css`,
	  vendor : [
	        	 'jquery' 
