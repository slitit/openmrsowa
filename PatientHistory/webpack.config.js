 ...
 */
// generated on 2022-05-24 using @openmrs/generator-openmrs-owa 0.7.1
'use strict';
...
const THIS_APP_ID = 'patienthistorymain';
...
var getConfig = function () {
	  ...
	  try {
	    ...
	    config = {
	      ...
	      'APP_ENTRY_POINT': 'http://localhost:8080/openmrs/owa/patienthistorymain/index.html'
	    };
...
var webpackConfig = {
  quiet: false,
  entry: {
	  app : `${__dirname}/app/js/patienthistorymain`,
	  css: `${__dirname}/app/css/patienthistorymain.css`,
	  vendor : [
	        	 'jquery' 
