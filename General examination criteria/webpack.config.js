 ...
 */
// generated on 2021-08-03 using @openmrs/generator-openmrs-owa 0.7.1
'use strict';
...
const THIS_APP_ID = 'generalexaminationcriteria';
...
var webpackConfig = {
  quiet: false,
  entry: {
	  app : `${__dirname}/app/js/generalexaminationcriteria`,
	  css: `${__dirname}/app/css/generalexaminationcriteria.css`,
	  vendor : [
	        	 'jquery' 
