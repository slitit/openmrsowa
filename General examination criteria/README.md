...
This repository contains the General Examination Criteria OpenMRS Open Web App.
...
This will create a file called `generalexaminationcriteria.zip` file in the `dist` directory,
...
This will build and deploy the app to the `C:/Users/Isuri/openmrs/server/owa`
...
```js
{
  "LOCAL_OWA_FOLDER": "C:/Users/Isuri/openmrs/server/owa"
}
```
...
{
  "LOCAL_OWA_FOLDER": "C:/Users/Isuri/openmrs/server/owa",
  "APP_ENTRY_POINT": "http://localhost:8080/openmrs/owa/generalexaminationcriteria/index.html"
}
```
