 ...
 */
// generated on 2022-05-25 using @openmrs/generator-openmrs-owa 0.7.1
'use strict';
...
const THIS_APP_ID = 'receivedrugs';
...
var getConfig = function () {
	  ...
	  try {
	    ...
	    config = {
	      ...
	      'APP_ENTRY_POINT': 'http://localhost:8080/openmrs/owa/receivedrugs/index.html'
	    };
...
var webpackConfig = {
  quiet: false,
  entry: {
	  app : `${__dirname}/app/js/receivedrugs`,
	  css: `${__dirname}/app/css/receivedrugs.css`,
	  vendor : [
	        	 'jquery' 
