...
This repository contains the RadiologyInvestigation OpenMRS Open Web App.
...
This will create a file called `radiologyinvestigation.zip` file in the `dist` directory,
