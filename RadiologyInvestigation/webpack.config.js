 ...
 */
// generated on 2022-05-02 using @openmrs/generator-openmrs-owa 0.7.1
'use strict';
...
const THIS_APP_ID = 'radiologyinvestigation';
...
var getConfig = function () {
	  ...
	  try {
	    ...
	    config = {
	      ...
	      'APP_ENTRY_POINT': 'http://localhost:8080/openmrs/owa/radiologyinvestigation/index.html'
	    };
...
var webpackConfig = {
  quiet: false,
  entry: {
	  app : `${__dirname}/app/js/radiologyinvestigation`,
	  css: `${__dirname}/app/css/radiologyinvestigation.css`,
	  vendor : [
	        	 'jquery' 
