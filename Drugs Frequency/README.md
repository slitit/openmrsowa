...
This repository contains the Drugs Frequency OpenMRS Open Web App.
...
This will create a file called `drugsfrequency.zip` file in the `dist` directory,
...
{
  "LOCAL_OWA_FOLDER": "C:/Users/Dilki/openmrs/newserver/owa",
  "APP_ENTRY_POINT": "http://localhost:8080/openmrs/owa/drugsfrequency/index.html"
}
```
