...
const THIS_APP_ID = 'labinvestigations';
...
var getConfig = function () {
	  ...
	  try {
	    ...
	    config = {
	      ...
	      'APP_ENTRY_POINT': 'http://localhost:8080/openmrs/owa/labinvestigations/index.html'
	    };
...
var webpackConfig = {
  quiet: false,
  entry: {
	  app : `${__dirname}/app/js/labinvestigations`,
	  css: `${__dirname}/app/css/labinvestigations.css`,
	  vendor : [
	        	 'jquery' 
