...
This repository contains the Investigations OpenMRS Open Web App.
...
This will create a file called `investigations.zip` file in the `dist` directory,
...
{
  "LOCAL_OWA_FOLDER": "C:/Users/Isuri/openmrs/server/owa",
  "APP_ENTRY_POINT": "http://localhost:8080/openmrs/owa/investigations/index.html"
}
```
