...
const THIS_APP_ID = 'stockadjustment';
...
var getConfig = function () {
	  ...
	  try {
	    ...
	    config = {
	      ...
	      'APP_ENTRY_POINT': 'http://localhost:8080/openmrs/owa/StockAdjestment/index.html'
	    };
...
var webpackConfig = {
  quiet: false,
  entry: {
	  app : `${__dirname}/app/js/stockadjustment`,
	  css: `${__dirname}/app/css/stockadjustment.css`,
	  vendor : [
	        	 'jquery' 
