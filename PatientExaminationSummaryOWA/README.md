...
# PatientExaminationDetail

This repository contains the PatientExaminationDetail OpenMRS Open Web App.
...
This will create a file called `patientexaminationdetail.zip` file in the `dist` directory,
...
{
  "LOCAL_OWA_FOLDER": "C:/Users/hp/openmrs/newserver/owa",
  "APP_ENTRY_POINT": "http://localhost:8080/openmrs/owa/patientexaminationdetail/index.html"
}
```
