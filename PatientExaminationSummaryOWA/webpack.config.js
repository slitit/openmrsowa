 ...
 */
// generated on 2022-04-07 using @openmrs/generator-openmrs-owa 0.7.1
'use strict';
...
const THIS_APP_ID = 'patientexaminationsummary';
...
var getConfig = function () {
	  ...
	  try {
	    ...
	    config = {
	      ...
	      'APP_ENTRY_POINT': 'http://localhost:8080/openmrs/owa/patientexaminationsummary/index.html'
	    };
...
var webpackConfig = {
  quiet: false,
  entry: {
	  app : `${__dirname}/app/js/patientexaminationsummary`,
	  css: `${__dirname}/app/css/patientexaminationsummary.css`,
	  vendor : [
	        	 'jquery' 
