...
# AuthorizationRequiredDrugsForPrescribing

This repository contains the AuthorizationRequiredDrugsForPrescribing OpenMRS Open Web App.
...
This will create a file called `authorizationrequireddrugsforprescribing.zip` file in the `dist` directory,
