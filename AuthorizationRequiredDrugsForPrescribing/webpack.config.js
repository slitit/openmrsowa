 ...
 */
// generated on 2022-05-17 using @openmrs/generator-openmrs-owa 0.7.1
'use strict';
...
const THIS_APP_ID = 'authorizationrequireddrugsforprescribing';
...
var getConfig = function () {
	  ...
	  try {
	    ...
	    config = {
	      ...
	      'APP_ENTRY_POINT': 'http://localhost:8080/openmrs/owa/authorizationrequireddrugsforprescribing/index.html'
	    };
...
var webpackConfig = {
  quiet: false,
  entry: {
	  app : `${__dirname}/app/js/authorizationrequireddrugsforprescribing`,
	  css: `${__dirname}/app/css/authorizationrequireddrugsforprescribing.css`,
	  vendor : [
	        	 'jquery' 
