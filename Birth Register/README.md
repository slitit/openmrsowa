...
This repository contains the Birth Register OpenMRS Open Web App.
...
This will create a file called `birthregister.zip` file in the `dist` directory,
...
This will build and deploy the app to the `C:/Users/Anjana/openmrs/newserver/owa/hregister/index.html`
...
```js
{
  "LOCAL_OWA_FOLDER": "C:/Users/Anjana/openmrs/newserver/owa/hregister/index.html"
}
```
...
{
  "LOCAL_OWA_FOLDER": "C:/Users/Anjana/openmrs/newserver/owa/hregister/index.html",
  "APP_ENTRY_POINT": "(http://localhost:8080/openmrs/owa/birt"
}
```
