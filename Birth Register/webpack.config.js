...
const THIS_APP_ID = 'birthregister';
...
var getConfig = function () {
	  ...
	  try {
	    ...
	    config = {
	      ...
	      'APP_ENTRY_POINT': 'http://localhost:8080/openmrs/owa/birthRegister/index.html'
	    };
...
var webpackConfig = {
  quiet: false,
  entry: {
	  app : `${__dirname}/app/js/birthregister`,
	  css: `${__dirname}/app/css/birthregister.css`,
	  vendor : [
	        	 'jquery' 
