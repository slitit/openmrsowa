 ...
 */
// generated on 2021-11-24 using @openmrs/generator-openmrs-owa 0.7.1
'use strict';
...
const THIS_APP_ID = 'historyinward';
...
var webpackConfig = {
  quiet: false,
  entry: {
	  app : `${__dirname}/app/js/historyinward`,
	  css: `${__dirname}/app/css/historyinward.css`,
	  vendor : [
	        	 'jquery' 
