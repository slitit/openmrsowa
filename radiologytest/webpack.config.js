 ...
 */
// generated on 2021-11-15 using @openmrs/generator-openmrs-owa 0.7.1
'use strict';
...
const THIS_APP_ID = 'radiologytest';
...
var webpackConfig = {
  quiet: false,
  entry: {
	  app : `${__dirname}/app/js/radiologytest.js`,
	  css: `${__dirname}/app/css/radiologytest.css`,
	  vendor : [
	        	 'jquery' 
