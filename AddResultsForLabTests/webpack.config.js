 ...
 */
// generated on 2022-07-18 using @openmrs/generator-openmrs-owa 0.7.1
'use strict';
...
const THIS_APP_ID = 'addresultsforlabtests';
...
var getConfig = function () {
	  ...
	  try {
	    ...
	    config = {
	      ...
	      'APP_ENTRY_POINT': 'http://localhost:8080/openmrs/owa/addresultsforlabtests/index.html'
	    };
...
var webpackConfig = {
  quiet: false,
  entry: {
	  app : `${__dirname}/app/js/addresultsforlabtests`,
	  css: `${__dirname}/app/css/addresultsforlabtests.css`,
	  vendor : [
	        	 'jquery' 
