...
# AddResultsForLabTests

This repository contains the AddResultsForLabTests OpenMRS Open Web App.
...
This will create a file called `addresultsforlabtests.zip` file in the `dist` directory,
