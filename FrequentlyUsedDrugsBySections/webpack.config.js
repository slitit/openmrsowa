...
const THIS_APP_ID = 'frequentlyuseddrugsbysections';
...
var getConfig = function () {
	  ...
	  try {
	    ...
	    config = {
	      ...
	      'APP_ENTRY_POINT': 'http://localhost:8080/openmrs/owa/frequentlyuseddrugsbysections/index.html'
	    };
...
var webpackConfig = {
  quiet: false,
  entry: {
	  app : `${__dirname}/app/js/frequentlyuseddrugsbysections`,
	  css: `${__dirname}/app/css/frequentlyuseddrugsbysections.css`,
	  vendor : [
	        	 'jquery' 
