...
# FrequentlyUsedDrugsBySections

This repository contains the FrequentlyUsedDrugsBySections OpenMRS Open Web App.
...
This will create a file called `frequentlyuseddrugsbysections.zip` file in the `dist` directory,
